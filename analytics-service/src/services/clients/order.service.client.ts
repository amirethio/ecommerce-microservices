...
export class OrderServiceClient {
	...
	async getTotalRevenue(params: {
		...
		const response = await this.client.get("/revenue/total", { params });
	...
	async getDailySales(params: {
		...
		const response = await this.client.get("/sales/daily", { params });
		return response.data;
	}
	...
	async getOrderStats(params: {
		...
		const response = await this.client.get("/stats/orders", {
			params: {
